  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="relative z-10 flex justify-between top-2 sm:px-20 px-7">
        <img src={`https://utterai.s3.ap-south-1.amazonaws.com/img/${teamOne && getFirstCharacter(teamOne)
          }.png`} className="w-20 object-contain" />
        ...
        <img src={`https://utterai.s3.ap-south-1.amazonaws.com/img/${teamTwo && getFirstCharacter(teamTwo)
          }.png`} className="w-20 object-contain" />
      </div>
    </div>
  );
